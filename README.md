...
1. Income is set at €800/month as a placeholder representing estimated student stipend/part-time income. Actual income      data to be updated when available.
2. Budget targets are monthly estimates based on realistic student living costs in Austria.
3. All figures are in EUR.
4. 3 month period is limited for robust trend analysis — model will be expanded to 12 months over time.
